...
action loss. Probe v2 **passed** the play gate: `play_moved: true`,
reward_sum **-150** vs floor **-161**, collisions 16 vs 17, **0 pellets**.
Next bounded probe: 128 optimizer steps, run id
`dgx-play-maze-chase-distill-probe-128-v1`. Do not jump to an unlabeled
long train. Record:
...
| — | Current campaign | Play-gated maze-chase distill v1. Probe v2 **passed** (`play_moved: true`, reward -150, collisions 16, 0 pellets). Next: 128-step play-gated probe `dgx-play-maze-chase-distill-probe-128-v1`. Not a 2048-step scale-up. |
