...
| 2 | Freeze implementation source and regenerate the matched-baseline architecture manifest | Done. Live digest `f4e9b355…` (2026-08-17 baseline-suite extension: reset-slot and dense-routing ablations). Historical `eb46988b…`, `5decb402…`, `30d4c119…`, and first-matched pin `52bba6a9…` unchanged. |
