...
def main():
    ...
    for manifest, expected in ((args.binding_root / 'evaluation-source-hashes.json',
                               None),
                              (args.root / 'evaluation-source-hashes.json', None)):
    ...
    report = {'status': 'running', 'models': {}, 'planned_tasks_per_model': 64,
              ...
              'source_manifest_sha256': digest(args.root / 'evaluation-source-hashes.json'),
