"""Target-blind, create-only preregistration for RCQ-v3 final qualification.
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build target-blind RCQ-v3 final preregistration"
    )
