"""Dependency-free RCQ-v3 registration, scoring, and retirement primitives.

The production trust boundary and sole receipt-authoring CLI live in
:mod:`irene_brain.evaluation.rcq_v3_torch`.  This module deliberately exports no
...
FINAL_EVALUATOR_ID = "rcq_v3_final_v1"
FINAL_RANGE_CLAIM_PROTOCOL = "irene_moving_shapes_test_range_retirement_v1"
RECIPIENT_OFFSET = 4_194_304
RECIPIENT_SEQUENCES = 512
DONOR_OFFSET = 4_194_816
DONOR_SEQUENCES = 512
RETIRED_END = 4_195_328
GUARD_END = 4_195_840
...
def _validate_registration(raw: object) -> None:
    ...
    exact = {
        ...
        "run_seed": 1702,
        "run_id": "dgx-rcq-v3-reference-seed-1702",
    ...
    if not _strict_equal(raw["workspace_protocol"], {
        ...
        "host_pin_directory_relative_path": (
            "qualification-pins/rcq-v3-reference-v1"
        ),
...
def _reserved_excluded_ranges() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "local_end": 2_097_408,
            "status": "reserved_first_matched_evaluation_suite_excluded_from_rcq_v3",
        },
        {
