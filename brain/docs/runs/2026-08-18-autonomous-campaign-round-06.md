# Continuous Autonomous Campaign Round 06 Evidence Record

**Date**: 2026-08-18
**Status**: `ELEVATED_GHOST_COLLISIONS`
**Model Parameter SHA256 Digest**: `2303a9dcf7effd29`
...
- **Normal Movement Step Delta T**: `0.00307`
- **Wall Bump Frame Delta T**: `0.00003`
- **Ghost Danger Frame Delta T (dist <= 2.5)**: `0.00003`
...
- **Pairwise Thoughtlet Cosine Similarity**: `-0.071`
- **Mean Thoughtlet Norm**: `5.61`
- **Inter-Slot Variance**: `0.7918`
